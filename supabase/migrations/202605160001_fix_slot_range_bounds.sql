-- Fix "range lower bound must be less than or equal to range upper bound"
-- caused by legacy bookings that have end_time < start_time.
  ...
  occupied as (
    ...
    where b.shop_id = p_shop_id
      ...
      and tstzrange(
        ...
        p_start_time,
        case when p_end_time > p_start_time then p_end_time else p_start_time + interval '1 minute' end,
        '[)'
      )
  )
